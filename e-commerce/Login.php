				...
				<div class="col-md-7">
					...
					<div class="billing-details">
						...
						<Form action="chkLogin.php" method="post">
							...
							<button type="submit" class="btn btn-link"><a class="primary-btn order-submit">LOGIN</a></button>
						</Form>
						<button type="submit" class="btn btn-link"><a href="AccountRegistrati.php" class="primary-btn order-submit">Registrati</a></button>
					</div>

			...
			<div class="row">
				...
				<div id="store" class="col-md-9">
					...
					<div class="row">
						...
						$page = "";
						$categoria = "";
						if (isset($_GET["SearchBar"])) $searceBar = $_GET["SearchBar"];
						if (isset($_GET["page"])) $page = $_GET["page"];
						if (isset($_GET["categorie"]) && $_GET["categorie"] != "All Categories") $categoria = $_GET["categorie"];
						StampArticoliStore($OrderBY, $searceBar, $page, $categoria);
						?>
					</div>
					<!-- /store products -->

...
<body onload="CheckCampi()">
                ...
                <div class="col-md-7">
                    ...
                    <div class="billing-details">
                        <Form enctype="multipart/form-data" action="chkAddIndirizzo.php" method="post">
                            ...
                            <div class="form-group">
                                <input id="Provincia" class="input" type="text" name="Provincia" placeholder="Provincia" onchange="CheckCampi()">
                            </div>
                            <div class="form-group">
    ...
    <script>
        function CheckCampi() {
            ...
            if (document.getElementById("Stato").value == "") ris = true;
            else if (document.getElementById("Regione").value == "") ris = true;
            else if (document.getElementById("Provincia").value == "") ris = true;
            else if (document.getElementById("Citta").value == "") ris = true;
            else if (document.getElementById("via").value == "") ris = true;
            else if (document.getElementById("Civico").value == "") ris = true;
            else if (document.getElementById("Cap").value == "") ris = true;
